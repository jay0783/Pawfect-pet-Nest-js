...
export interface GetDayScheduleResponse extends PaginationResponse<ScheduleItem> { }
...
export async function makeScheduleItem(orderEntity: OrderEntity): Promise<ScheduleItem> {
  ...
  const [petsViewModel, employeeViewModel, customerViewModel, orderViewModel, serviceViewModel] = await Promise.all([
