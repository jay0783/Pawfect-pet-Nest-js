...
!(function (global, setTimeout) {
    ...
    function d(a) {
      isBrowser &&
        each(scripts(), function (b) {
          return b.getAttribute('data-requiremodule') === a &&
      ...
      (t.prototype = {
        ...
        fetch: function () {
          if (!this.fetched) {
            ...
            var a = this.map;
            return this.shim
              ? void u.makeRequire(this.map, { enableBuildCallback: !0 })(
                  this.shim.deps || [],
                  bind(this, function () {
  ...
  function getInteractiveScript() {
    return interactiveScript && 'interactive' === interactiveScript.readyState
      ...
      : (eachReverse(scripts(), function (a) {
          return 'interactive' === a.readyState
            ? (interactiveScript = a)
            : void 0;
        }),
        interactiveScript);
  ...
  if ('undefined' == typeof define) {
    ...
    'undefined' == typeof require ||
      ...
      (PayJS = req = requirejs = function (a, b, c, d) {
        var e,
          f,
          g = defContextName;
        return (
  ...
  (function () {
    const a = 'https://www.sagepayments.net/pay/1.0.2';
    var b = {
      paths: {
